...
class Grid(object):
    ...
    def interpolateToGrid(self,geodict,method='linear'):
        ...
        @raise GridException: If the Grid object upon which this function is being called is not completely 
                          contained by the grid to which this Grid is being resampled.
        @raise GridException: If the resulting interpolated grid shape does not match input geodict.
